...
class AppConstants {
  ...
  static TextStyle themeFontTextWithColor(BuildContext context) => TextStyle(
  ...
  static Color themeBGColor(BuildContext context) =>
      Theme.of(context).scaffoldBackgroundColor;
  static Color dialogBGColor(BuildContext context) =>
